  ...
  render() {
    return <Container>
      ...
      <Content>
        ...
        <Image style={styles.footerImage} source={{ uri: "https://res.cloudinary.com/ogcodes/image/upload/v1568759432/feedback.jpg" }} style={{ width: 3216 / 10, height: 2136 / 13, margin: 20 }} />
      </Content>
